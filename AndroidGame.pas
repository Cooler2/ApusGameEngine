...
//
// Copyright (C) 2017 Apus Software (www.games4win.com, www.apus-software.com)
// Author: Ivan Polyacov (cooler@tut.by)
unit AndroidGame;
interface
 uses jni,EngineCls,Images,engineTools,classes,myservis,BasicGame,UIClasses;
...
implementation
 uses Android,SysUtils,cmdproc,EventMan,ImageMan,CommonUI,gfxformats,
     Console,gles20,GLImages,PainterGL2;
