...
{ TTexInterpolateMode=(tintFactor, // factor=constant
 ...
 TGameBase=class
  ...
  function RunAsync(threadFunc:TAsyncProc;param:UIntPtr=0;ttl:single=0;name:string=''):THandle; virtual; abstract;
...
var
 ...
 // ---------------------------------------
 // Ownership:
 // - systemPlatform/gfx are assigned by TGameBase during game creation
 ...
 function CreateImageFrom(str:string8;padding:integer=0;flags:cardinal=0):TTexture;
...
function CreateImageFrom(str:string8;padding:integer;flags:cardinal):TTexture;
 begin
  result:=Apus.Engine.ImageTools.CreateImageFromString(str,padding,flags);
 end;
