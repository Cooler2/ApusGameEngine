...
unit Apus.Engine.GLgame;

interface
 uses Apus.Engine.EngineAPI, Apus.Images, Apus.Engine.EngineTools, Apus.MyServis, Apus.Engine.BasicGame;
...
implementation
 uses Types, SysUtils, Apus.Engine.CmdProc, Windows, Apus.FastGFX,

         {$IFNDEF GLES}dglOpenGL,{$ENDIF}
     Apus.Engine.GLImages, Apus.EventMan, Apus.Engine.UIClasses, Apus.Engine.UIScene, Apus.GFXFormats,
     Apus.Engine.Console, Apus.Engine.PainterGL, Apus.Engine.PainterGL2, Apus.Engine.BasicPainter;
