...
interface
 uses {$IFDEF MSWINDOWS}Windows,{$ENDIF}Apus.Engine.API,
    Apus.Images,Apus.Engine.UIClasses,Apus.Regions,Apus.MyServis,
...
implementation
 uses SysUtils,{$IFDEF DIRECTX}DirectXGraphics,d3d8,Apus.Engine.DxImages8,{$ENDIF}
    ...
    Apus.Engine.UDict,Apus.Engine.ImgLoadQueue,Apus.Engine.GfxFormats3D;
