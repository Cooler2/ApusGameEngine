...
function FT_New_Memory_Face(alibrary: PFT_Library; file_base: PByte; file_size: FT_Long; face_index: integer; out aface: PFT_Face): integer; cdecl; external freetypedll Name 'FT_New_Memory_Face';
...
function FT_Render_Glyph(slot:PFT_GlyphSlot;render_mode:FT_Render_Mode):integer; cdecl; external freetypedll;
